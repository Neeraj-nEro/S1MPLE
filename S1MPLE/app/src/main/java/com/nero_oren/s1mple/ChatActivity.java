...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MessageImageStorageRef = FirebaseStorage.getInstance().getReference().child("Messages_Pic");
        ...
        rootRef.child("Users").child(messageReceiverId).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.with(ChatActivity.this).load(userThumb).networkPolicy(NetworkPolicy.OFFLINE).placeholder(R.drawable.default_pic)
                        .into(userChatProfileImage, new Callback() {
                            ...
                            @Override
                            public void onError() {
                                Picasso.with(ChatActivity.this).load(userThumb).placeholder(R.drawable.default_pic).into(userChatProfileImage);
                            }
                        });
                ...
                if(online.equals("true")){
                    ...
                    String lastSeenDisplayingTime = getTime.getTimeAgo(last_seen, getApplicationContext()).toString();
                    UserLastSeen.setText(lastSeenDisplayingTime);
                }
            }
